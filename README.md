...
各カットの操作欄・タイムライン・プレビュー枠のコピー／ペーストアイコンで演出を移せます。歌詞同士、または前景・背景同士で利用できます。貼り付け先の本文・素材・開始時刻・表示エリア／配置は維持し、文字のレイアウトは貼り付け先の歌詞に合わせて再構成します。貼り付けはアンドゥ／やり直しに対応します。クリップボードが使えない環境では、同じページ内でのコピー・ペーストを利用できます。
